Experiment on using Firebase services with a web application.

The goal for this experiment is to utilize Firebase Storage service and create 
an drag-and-drop style file upload interface.
